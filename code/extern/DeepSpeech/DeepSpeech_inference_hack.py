...
import extern.DeepSpeech.evaluate
import numpy as np
import progressbar
import shutil
import tempfile
...
from extern.DeepSpeech.util.audio import audiofile_to_input_vector
from extern.DeepSpeech.util.config import Config, initialize_globals
from extern.DeepSpeech.util.coordinator import TrainingCoordinator
from extern.DeepSpeech.util.feeding import DataSet, ModelFeeder
from extern.DeepSpeech.util.flags import create_flags, FLAGS
from extern.DeepSpeech.util.logging import log_info, log_error, log_debug, log_warn
from extern.DeepSpeech.util.preprocess import preprocess
from extern.DeepSpeech.util.text import Alphabet
